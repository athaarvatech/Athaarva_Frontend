                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Allow your healthcare providers to share your data with
                        each other
                      </p>
                    </div>
                    <Switch
                      ...
                      onCheckedChange={(value) =>
                        handlePrivacySettingChange("allowDataSharing", value)
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Allow designated family members to view your health
                        information
                      </p>
                    </div>
                    <Switch
                      ...
                      onCheckedChange={(value) =>
                        handlePrivacySettingChange("showFamilyAccess", value)
                      }
                    />
                  </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-amber-700">
                            To ensure your account security, please verify your
                            email address.
                          </p>
