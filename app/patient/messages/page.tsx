...
const mockConversations: Conversation[] = [
  {
    ...
    lastMessage:
      "Your blood test results look normal. Let me know if you have any questions.",
    ...
    messages: [
      {
        ...
        sender: "doctor",
        content:
          "Hello! I hope you are feeling better today. I've reviewed your test results.",
      ...
      },
      {
        ...
        sender: "patient",
        content:
          "Hi Dr. Johnson, thank you for checking. I'm feeling much better, just a bit tired still.",
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        ...
        sender: "patient",
        content:
          "Thank you, Dr. Chen. I'll pick it up today. How often should I take it?",
    ...
    messages: [
      {
        ...
        sender: "staff",
        content:
          "Hello! I wanted to confirm your appointment with Dr. Johnson.",
                ...
                {filteredConversations.map((conv) => (
                  <div
                    ...
                    onClick={() => {
                      ...
                      markAsRead(conv.id);
                      router.push(`/patient/messages?id=${conv.id}`, {
                        scroll: false,
                      });
                    }}
                  >
                ...
                {activeConversation.messages.map((message) => (
                  ...
                  >
                    ...
                    >
                      ...
                      {message.attachment && (
                        <div
                          className={`mt-2 p-2 rounded flex items-center gap-2 text-sm ${
                            message.sender === "patient"
                              ? "bg-white/20"
                              : "bg-white"
                          }`}
        ...
        <DialogContent className="sm:max-w-lg">
          ...
          <div className="space-y-4 py-4">
            <div>
              ...
              <Select
                ...
                onValueChange={setNewMessageDoctor}
              >
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={
                !newMessageDoctor || !newMessageContent.trim() || isSending
              }
            >
