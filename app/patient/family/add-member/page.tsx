...
export default function AddFamilyMemberPage() {
  ...
  // Handle input changes for native input elements
  ...
  // Helper to update nested or flat field
  ...
  // Handle checkbox changes from Radix UI Checkbox components
        ...
        <CardContent className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2 pt-4">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      handleCheckboxChange("isMinor", checked)
                    }
                  />
                ...
                {memberInfo.isMinor && (
                  <div className="p-3 bg-blue-50 rounded-md text-sm text-blue-700">
                    For minors under 18, you will be designated as their
                    caregiver and have full access to their health information.
                  </div>
                )}
              </div>
            </div>
                ...
                <div className="pt-4">
                  <div className="flex items-center space-x-2 mb-4">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        handleCheckboxChange("address.sameAsMe", checked)
                      }
                    />
                ...
                <div className="pt-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        handleCheckboxChange("isCaregiver", checked)
                      }
                    />
                    <Label htmlFor="isCaregiver">
                  ...
                  {memberInfo.isCaregiver && (
                    <div className="p-3 bg-blue-50 rounded-md mt-2 text-sm text-blue-700">
                      As a caregiver, this person will have access to your
                      health information and can help manage your care.
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-sm text-amber-700">
                        When sharing health information with family members,
                        please consider privacy implications. You can customize
                        exactly what information is shared below.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-2 pb-4 border-b">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      handleCheckboxChange("shareData", checked);

                      // If shareData is unchecked, uncheck all sharing options
                      if (!checked) {
                        handleCheckboxChange("shareAll", false);
                        handleCheckboxChange("shareAppointments", false);
                        handleCheckboxChange("shareMedications", false);
                        handleCheckboxChange("shareVitals", false);
                        handleCheckboxChange("shareLabResults", false);
                      }
                    }}
                  />
                  <Label htmlFor="shareData" className="font-medium">
                    Share health information with this person
                  </Label>
                </div>
                  ...
                  <div className="space-y-3 pt-2">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => {
                          handleCheckboxChange("shareAll", checked);

                          // If shareAll is checked, check all options
                          if (checked) {
                            handleCheckboxChange("shareAppointments", true);
                            handleCheckboxChange("shareMedications", true);
                            handleCheckboxChange("shareVitals", true);
                            handleCheckboxChange("shareLabResults", true);
                          }
                        }}
                      />
                      <Label htmlFor="shareAll" className="font-medium">
                      ...
                      <div className="space-y-2 pl-6">
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              handleCheckboxChange("shareAppointments", checked)
                            }
                          />
                          <Label htmlFor="shareAppointments">
                            Appointments
                          </Label>
                        </div>
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              handleCheckboxChange("shareMedications", checked)
                            }
                          />
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              handleCheckboxChange("shareVitals", checked)
                            }
                          />
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              handleCheckboxChange("shareLabResults", checked)
                            }
                          />
          ...
          <div className="mt-8 flex justify-between">
            ...
            <Button
              ...
              disabled={
                !isStepValid() || (step === 3 && saveStatus === "saving")
              }
            >
              {step < 3 ? (
                "Continue"
