...
function PaymentSetupStep({ data, updateData, onStepComplete }: PaymentSetupStepProps) {
  ...
  const getSuggestedFees = useCallback(() => {
    if (personalInfo.specializations.length > 0) {
      ...
      return specializationFees[primarySpecialization as keyof typeof specializationFees] || {
        min: 300,
        max: 1000,
        suggested: 500
      };
  ...
  const validateConsultationFee = (fee: number) => {
    ...
    if (fee < 100) {
      setErrors(prev => ({ ...prev, consultationFee: "Minimum fee should be ₹100" }));
      return false;
    }
    if (fee > 10000) {
      setErrors(prev => ({ ...prev, consultationFee: "Maximum fee should be ₹10,000" }));
      return false;
    }
    setErrors(prev => {
  ...
  const validateBankDetails = useCallback(() => {
    const { accountHolder, accountNumber, ifscCode, bankName } = payment.bankDetails;
  ...
  const handleInputChange = (field: string, value: any) => {
    if (field === "consultationFee" || field === "telehealthFee") {
      ...
      currentBankDetails[bankField as keyof typeof currentBankDetails] = value;
  ...
  const isStepComplete = useCallback(() => {
    return (
      ...
      (selectedPaymentMethods.includes("bank_transfer") ? bankDetailsValid : true) &&
      Object.keys(errors).length === 0
    );
  }, [payment.consultationFee, payment.telehealthFee, selectedPaymentMethods, bankDetailsValid, errors]);
        ...
        <Card className="border border-gray-100">
          <CardContent className="p-6 space-y-6">
            <div className="flex items-center space-x-3">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Consultation Fees</h3>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={cn(
                      ...
                      errors.consultationFee ? "border-red-500 focus:border-red-500" : ""
                    )}
                    min="100"
                    max="10000"
                  />
              ...
              <div className="space-y-2">
                <Label htmlFor="telehealthFee" className="text-sm font-medium text-gray-700">
                  Telehealth Consultation Fee *
                </Label>
                <div className="relative">
                  <IndianRupee className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" />
                  <Input
                    ...
                    onChange={(e) => handleInputChange("telehealthFee", e.target.value)}
                    className="pl-10"
                    min="100"
                    max="10000"
                  />
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <span className="ml-2 font-medium">₹{payment.consultationFee}</span>
                  </div>
                  <div>
                    <span className="text-gray-600">Telehealth:</span>
                    <span className="ml-2 font-medium">₹{payment.telehealthFee}</span>
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-sm text-yellow-800">
                    ...
                    <p>Your bank details are encrypted and stored securely. We use industry-standard security measures to protect your financial information.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={cn(
                      "transition-colors",
                      errors.accountHolder ? "border-red-500 focus:border-red-500" : ""
                    )}
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={cn(
                      ...
                      errors.ifscCode ? "border-red-500 focus:border-red-500" : ""
                    )}
                  />
                  {errors.ifscCode && (
                    <p className="text-sm text-red-600 flex items-center gap-1">
      ...
      >
        <Card className="border border-gray-100 bg-gradient-to-br from-healthcare-cool-white to-white">
          <CardContent className="p-6">
            <h4 className="font-semibold text-gray-900 mb-4">Payment Setup Summary</h4>
            <div className="grid md:grid-cols-3 gap-6 text-sm">
              <div>
                <p className="font-medium text-gray-700 mb-2">Consultation Fees</p>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  {selectedPaymentMethods.includes("bank_transfer") 
                    ? (bankDetailsValid ? "Configured" : "Pending") 
                    : "Not required"
                  }
                </p>
              </div>
