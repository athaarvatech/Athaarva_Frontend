...
const HospitalOnboardingPage = dynamic(() => import("./hospital/page"), {
  ssr: false,
});
...
export default function OnboardingPage() {
        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-sm text-slate-600 space-y-2">
              <p>
                <strong>Common reasons for invalid invitations:</strong>
              </p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-healthcare-cool-white via-white to-emerald-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-emerald-700">
                  Welcome! Your invitation for{" "}
                  <strong>{validation.email}</strong> is valid.
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-2 text-sm text-emerald-700">
              ...
              <span>
                Expires:{" "}
                {validation.expires_at && formatDate(validation.expires_at)}
              </span>
            </div>
          </div>
        </div>
      ...
      {Boolean(validation.hospital_draft) && (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-blue-700">
                Some hospital information has been pre-filled for your
                convenience.
              </span>
            </div>
          </div>
...
function TokenAwareHospitalOnboarding({
  ...
  // Store token and validation data in sessionStorage for the onboarding flow
