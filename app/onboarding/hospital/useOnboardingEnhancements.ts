...
export const ONBOARDING_WALKTHROUGH_STEPS: WalkthroughStep[] = [
  {
    ...
    content: "This sidebar shows all the steps in your onboarding journey. Completed steps are marked with a green checkmark. Click any step to jump directly to it.",
    target: "[data-walkthrough='progress-sidebar']",
    position: "right",
  },
  {
    id: "step-content",
    title: "Step Content Area",
    content: "This is where you'll fill in your hospital's information. Each step focuses on a specific aspect of your hospital setup. All fields are auto-saved as you type.",
    target: "[data-walkthrough='step-content']",
    position: "top",
  },
  {
    id: "autosave-indicator",
    title: "Auto-Save Feature",
    content: "Your progress is automatically saved every few seconds. Look for the 'Saved' indicator to confirm your data is secure. You can safely close and resume later.",
    target: "[data-walkthrough='autosave-indicator']",
    position: "bottom",
  },
  {
    id: "help-button",
    title: "Need Help?",
    content: "Click the info icon for context-specific help about each step. We've included detailed guidance to make the process smooth.",
  ...
  },
  {
    ...
    content: "Use the Previous and Next buttons to move between steps. You can also click directly on a completed step in the sidebar to jump back to it.",
