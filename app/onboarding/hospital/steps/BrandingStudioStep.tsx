...
const COLOR_PRESETS = [
  { name: 'Healthcare Teal', primary: '#007C7C', secondary: '#20B2AA', accent: '#10B981', neutral: '#6B7280' },
  { name: 'Medical Blue', primary: '#1E40AF', secondary: '#3B82F6', accent: '#60A5FA', neutral: '#6B7280' },
  { name: 'Wellness Green', primary: '#059669', secondary: '#10B981', accent: '#34D399', neutral: '#6B7280' },
  { name: 'Premium Purple', primary: '#7C3AED', secondary: '#8B5CF6', accent: '#A78BFA', neutral: '#6B7280' },
];
...
export default function BrandingStudioStep() {
  ...
  }, [branding.colors.primary, branding.colors.secondary, branding.colors.accent]);
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">Choose colors that represent your brand</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <ColorPicker
                ...
                onChange={(color) => updateData('branding', {
                  colors: { ...branding.colors, primary: color },
                })}
                help={{
                  title: 'Primary Color',
                  content: 'Your main brand color. Used for headers, buttons, and key UI elements.',
                  tips: ['Choose a color that represents your brand identity', 'Ensure good contrast with white backgrounds'],
                }}
              />
              ...
              <ColorPicker
                ...
                help={{
                  ...
                  content: 'Supporting color for accents, links, and secondary actions.',
                }}
              />
              ...
              <ColorPicker
                ...
                help={{
                  title: 'Accent Color',
                  content: 'Used for highlights, success states, and call-to-action elements.',
                }}
              />
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField
                ...
                help={{
                  ...
                  tips: ['Choose a bold, readable font', 'Sans-serif fonts work well for healthcare'],
                }}
              >
                <Select
                  value={branding.typography.heading_font}
                  onValueChange={(value) => updateData('branding', {
                    typography: { ...branding.typography, heading_font: value },
                  })}
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <FormField
                ...
                help={{
                  title: 'Body Font',
                  content: 'Font used for body text, paragraphs, and descriptions',
                  tips: ['Choose a highly readable font', 'Can be the same as heading font for consistency'],
                }}
              >
                <Select
            ...
            <div className="mt-6 p-6 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <div style={{ fontFamily: branding.typography.heading_font }}>
                <h1 className="text-3xl font-bold mb-2" style={{ color: branding.colors.primary }}>
                  Welcome to Our Hospital
                </h1>
                <h2 className="text-2xl font-semibold mb-2" style={{ color: branding.colors.secondary }}>
                  Quality Healthcare for Everyone
                </h2>
              </div>
              <div style={{ fontFamily: branding.typography.body_font }} className="mt-4">
                <p className="text-base text-gray-700 leading-relaxed">
                  Our mission is to provide exceptional healthcare services with compassion and expertise. 
                  We combine cutting-edge medical technology with personalized care to ensure the best 
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <FileUploadZone
                ...
                onFileSelect={(file) => updateData('branding', { logo_file: file })}
                onFileRemove={() => updateData('branding', { logo_file: null, logo_url: '' })}
                onUploadComplete={(url) => updateData('branding', { logo_url: url })}
                accept="image/*"
                maxSizeMB={2}
                preview
              />
              ...
              <FileUploadZone
                ...
                onFileSelect={(file) => updateData('branding', { hero_asset_file: file })}
                onFileRemove={() => updateData('branding', { hero_asset_file: null, hero_asset_url: '' })}
                onUploadComplete={(url) => updateData('branding', { hero_asset_url: url })}
                accept="image/*"
                maxSizeMB={5}
                preview
              />
              ...
              <FileUploadZone
                ...
                onFileSelect={(file) => updateData('branding', { favicon_file: file })}
                onFileRemove={() => updateData('branding', { favicon_file: null, favicon_url: '' })}
                onUploadComplete={(url) => updateData('branding', { favicon_url: url })}
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-700 mt-1">
                    Your color palette meets WCAG AA standards for contrast and accessibility.
                  </p>
                </div>
              </div>
            </motion.div>
