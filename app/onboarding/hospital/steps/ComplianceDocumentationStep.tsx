...
import { Plus, FileText, Shield, User, Phone, Mail, AlertCircle, Upload, Calendar, X } from 'lucide-react';
...
export default function ComplianceDocumentationStep() {
  ...
  const documents = Array.isArray(compliance.documents) ? compliance.documents : [];
  const dpoContact = compliance.dpo_contact || { name: '', email: '', phone: '' };
  const consentTemplates = Array.isArray(compliance.consent_templates) ? compliance.consent_templates : [];
  ...
  const addConsentTemplate = (type: string, fileUrl: string, fileName: string) => {
  ...
  const removeConsentTemplate = (id: string) => {
    updateData('compliance', {
      ...compliance,
      consent_templates: consentTemplates.filter((t: ConsentTemplate) => t.id !== id),
    } as any);
  };
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 mt-1">
          Upload compliance documents, assign Data Protection Officer, and provide consent templates
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <Label className="text-base font-medium">Data Protection Officer (DPO)</Label>
          <HelpPopover
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h4 className="font-semibold text-gray-900">DPO Contact Information</h4>
              <p className="text-sm text-gray-600">Required for GDPR/data privacy compliance</p>
            </div>
          </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <Label className="text-base font-medium">Consent Form Templates</Label>
          <Button
        ...
        {showTemplateUpload && (
          ...
          >
            <div className="flex items-center justify-between">
              <h4 className="font-semibold text-gray-900">Upload Consent Template</h4>
              <Button
                variant="ghost"
                size="sm"
                onClick={() => {
            ...
            {newTemplateType && (
              <FileUploadZone
                ...
                onUploadComplete={(url) => {
                  addConsentTemplate(newTemplateType, url, 'consent-template.pdf');
                }}
                accept=".pdf,.doc,.docx"
                maxSizeMB={10}
        ...
        {consentTemplates.length === 0 && !showTemplateUpload && (
          <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
            ...
            <p className="text-gray-600 mb-4">No consent templates uploaded yet</p>
            <Button onClick={() => setShowTemplateUpload(true)} variant="outline">
              <Plus className="w-4 h-4 mr-2" />
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h4 className="font-semibold text-blue-900 mb-1">Compliance Checklist</h4>
            <ul className="space-y-1 text-sm text-blue-800">
              ...
              <li className="flex items-center gap-2">
                <span className={cn(
                  "w-2 h-2 rounded-full",
                  dpoContact.name && dpoContact.email && dpoContact.phone ? "bg-green-500" : "bg-gray-300"
                )} />
