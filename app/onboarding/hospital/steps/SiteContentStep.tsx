    ...
    <div className="space-y-6">
        ...
        <div className="space-y-4">
          <FormField label="Headline" required wordCount maxWords={80}>
            <Input
              ...
              onChange={(e) => updateData('siteContent', {
      ...
      >
        <div className="bg-gradient-to-r from-healthcare-primary/5 to-healthcare-teal/5 px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900">Services Highlights</h3>
        ...
        <div className="p-6 space-y-4">
          {data.siteContent.services_highlights?.map((service: any, index: number) => (
            <div key={service.id || index} className="border border-gray-200 rounded-lg p-4 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() => {
                    const updated = [...(data.siteContent.services_highlights || [])];
                    updated.splice(index, 1);
                    updateData('siteContent', { services_highlights: updated });
                  }}
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <FormField label="Icon" required>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="heart">❤️ Heart (Cardiology)</SelectItem>
                      <SelectItem value="brain">🧠 Brain (Neurology)</SelectItem>
                      <SelectItem value="bone">🦴 Bone (Orthopedics)</SelectItem>
                      <SelectItem value="eye">👁️ Eye (Ophthalmology)</SelectItem>
                      <SelectItem value="tooth">🦷 Tooth (Dentistry)</SelectItem>
          ...
          <Button
            variant="outline"
            onClick={() => {
              const newService = { id: Date.now(), icon: '', title: '', description: '' };
              updateData('siteContent', {
                services_highlights: [...(data.siteContent.services_highlights || []), newService]
              });
            }}
            className="w-full"
          >
      ...
      >
        <div className="bg-gradient-to-r from-amber-50 to-orange-50 px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900">Patient Testimonials</h3>
          <p className="text-sm text-gray-600 mt-1">
        ...
        <div className="p-6 space-y-4">
          {data.siteContent.testimonials?.map((testimonial: any, index: number) => (
            <div key={testimonial.id || index} className="border border-gray-200 rounded-lg p-4 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() => {
                    const updated = [...(data.siteContent.testimonials || [])];
                    updated.splice(index, 1);
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField label="Patient Name" required>
                  <Input
                    ...
                    onChange={(e) => {
                      const updated = [...(data.siteContent.testimonials || [])];
                      updated[index] = { ...updated[index], patient_name: e.target.value };
                      updateData('siteContent', { testimonials: updated });
                    }}
          ...
          <Button
            ...
            onClick={() => {
              ...
              updateData('siteContent', {
                testimonials: [...(data.siteContent.testimonials || []), newTestimonial]
              });
            }}
            className="w-full"
          >
      ...
      >
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900">Blog/News Teasers</h3>
          <p className="text-sm text-gray-600 mt-1">
        ...
        <div className="p-6 space-y-4">
          {data.siteContent.blog_teasers?.map((teaser: any, index: number) => (
            <div key={teaser.id || index} className="border border-gray-200 rounded-lg p-4 space-y-4">
              <div className="flex items-center justify-between">
                <h4 className="text-sm font-medium text-gray-900">Blog Post #{index + 1}</h4>
                {data.siteContent.blog_teasers && data.siteContent.blog_teasers.length > 3 && (
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField label="Publish Date" required>
                  <Input
                    ...
                    onChange={(e) => {
                      const updated = [...(data.siteContent.blog_teasers || [])];
                      updated[index] = { ...updated[index], publish_date: e.target.value };
                      updateData('siteContent', { blog_teasers: updated });
                    }}
                  />
                </FormField>
          ...
          {(!data.siteContent.blog_teasers || data.siteContent.blog_teasers.length < 3) && (
            <Button
              ...
              onClick={() => {
                ...
                updateData('siteContent', {
                  blog_teasers: [...(data.siteContent.blog_teasers || []), newTeaser]
                });
              }}
              className="w-full"
            >
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        {wordCount && (
          <Badge variant={maxWords && words > maxWords ? 'destructive' : 'secondary'} className="text-xs">
