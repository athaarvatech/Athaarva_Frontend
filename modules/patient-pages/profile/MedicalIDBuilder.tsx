    ...
    <div className="space-y-6">
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            Create your medical ID for emergency access with essential health
          ...
          <div className="space-y-4">
            <div className="p-3 bg-[#F0F9FA] border border-[#E8F3F4] rounded-lg text-sm">
              <p className="flex items-center text-[#006D77]">
                ...
                Your Medical ID can be accessed by emergency responders even
                when your phone is locked. Only include information you want to
                      ...
                      <div className="bg-gray-100 p-4 rounded-lg border border-gray-200 max-w-xs mx-auto">
                        <div className="p-4 bg-white rounded-lg border border-gray-300 shadow-sm">
                          ...
                          <div className="space-y-3">
                            ...
                            {medicalIDData.includeAllergies &&
                              medicalIDData.allergies.length > 0 && (
                                <div>
                            ...
                            {medicalIDData.includeConditions &&
                              medicalIDData.conditions.length > 0 && (
                                <div>
                                  <p className="text-sm font-bold">
                                    Medical Conditions:
                                  </p>
                            ...
                            {medicalIDData.includeMedications &&
                              medicalIDData.medications.length > 0 && (
                                <div>
                                  <p className="text-sm font-bold">
                                    Medications:
                                  </p>
                            ...
                            {medicalIDData.includeEmergencyContact && (
                              <div>
                                ...
                                <p className="text-sm">
                                  {medicalIDData.emergencyContact}
                                </p>
                              </div>
                            )}
                    ...
                    <div className="bg-white border rounded-lg p-4 shadow-sm">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-start space-x-2">
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              handleSwitchChange("lockScreenEnabled", checked)
                            }
                          />
                          <div>
                            <Label
                              htmlFor="lockScreenEnabled"
                              className="font-medium"
                            >
                              Enable Lock Screen Access
                            </Label>
                            <p className="text-sm text-gray-600">
                              Allow emergency responders to access your Medical
                              ID from your lock screen
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start space-x-2">
                          ...
                          <div>
                            <Label
                              htmlFor="emergencyAccessEnabled"
                              className="font-medium"
                            >
                              Enable QR Code
                            </Label>
                            <p className="text-sm text-gray-600">
                              Generate a QR code that links to your medical
                              information for emergency access
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mt-4 pt-3 border-t">
                        ...
                        <p className="text-xs text-gray-500 mt-2 text-center">
                          Follow instructions to enable Medical ID on your
                          phone's lock screen
                        </p>
                      </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-start space-x-2">
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              handleSwitchChange("wristbandEnabled", checked)
                            }
                          />
                          <div>
                            <Label
                              htmlFor="wristbandEnabled"
                              className="font-medium"
                            >
                              Generate Wristband Design
                            </Label>
                            <p className="text-sm text-gray-600">
                              Create a printable design for medical alert
                              wristbands
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="bg-[#F0F9FA] border border-[#E8F3F4] rounded-lg p-4">
                      <h3 className="font-medium text-[#006D77] mb-2">
                        Order Professional Wristband
                      </h3>
                      <p className="text-sm text-gray-600 mb-3">
                        Order a durable, professionally made medical alert
                        wristband using your custom design.
                      </p>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleSwitchChange("includeBloodType", checked)
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleSwitchChange("includeAllergies", checked)
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleSwitchChange("includeConditions", checked)
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleSwitchChange("includeMedications", checked)
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleSwitchChange("includeEmergencyContact", checked)
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <Label
                        htmlFor="includeAdvanceDirectives"
                        className="cursor-pointer"
                      >
                        Advance Directives
                      </Label>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-2 p-2 border rounded-md bg-gray-50 min-h-10">
                          {medicalIDData.allergies.map((allergy, index) => (
                            <div
                              key={index}
                              className="flex items-center bg-white px-2 py-1 rounded-md border text-sm"
                            >
                              {allergy}
                              <Button
                                variant="ghost"
                                ...
                                onClick={() => {
                                  const newAllergies = [
                                    ...medicalIDData.allergies,
                                  ];
                                  newAllergies.splice(index, 1);
                                  handleFieldChange("allergies", newAllergies);
                                }}
                              >
                                <X size={12} />
                              </Button>
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            className="rounded-md text-[#006D77]"
                          >
                      ...
                      <div className="p-3 bg-amber-50 border border-amber-100 rounded-lg flex items-start">
                        ...
                        <p className="text-xs text-amber-700">
                          Your Medical ID information should be concise and
                          focus on critical information that would help
                          emergency responders provide appropriate care.
                        </p>
                      </div>
                    </div>
                  </div>
