...
const AccessibilitySettings = () => {
  ...
  const handleToggleSwitch = (
    ...
    setAccessibilitySettings({
      ...
      [category]: {
        ...accessibilitySettings[
          category as keyof typeof accessibilitySettings
        ],
        [setting]: value,
      },
    });
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            Customize the appearance and behavior of HealthCare to meet your
            accessibility needs.
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div className="space-y-4 bg-gray-50 p-4 rounded-lg">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleToggleSwitch("visual", "highContrast", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleToggleSwitch("visual", "largeText", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleToggleSwitch("visual", "reduceMotion", checked)
                    }
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Slider
                      id="font-scale"
                      defaultValue={[
                        accessibilitySettings.visual.fontSizeScale,
                      ]}
                      max={2.0}
                      min={0.8}
                      step={0.1}
                      onValueChange={(value) =>
                        handleSliderChange("visual", "fontSizeScale", value)
                      }
                      className="flex-1"
                    />
                    <Type size={20} />
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Current scale:{" "}
                    {accessibilitySettings.visual.fontSizeScale.toFixed(1)}x
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleSelectChange("visual", "colorBlindMode", value)
                    }
                  >
                ...
                <div className="bg-white p-3 border rounded-lg mt-3">
                  <h4 className="text-sm font-medium mb-2">
                    Preview with selected settings
                  </h4>
                  <div
                    className={`p-3 border rounded-md ${
                      accessibilitySettings.visual.highContrast
                        ? "bg-black text-white"
                        : "bg-gray-50"
                    }`}
                  >
                    <p
                      style={{
                        fontSize: `${
                          accessibilitySettings.visual.largeText
                            ? accessibilitySettings.visual.fontSizeScale * 100
                            : 100
                        }%`,
                      }}
                    >
                      This is a preview of how text will appear with your
                      selected settings.
                    </p>
              ...
              <div className="space-y-4 bg-gray-50 p-4 rounded-lg">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleToggleSwitch("audio", "screenReader", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Audible feedback when interacting with controls
                    </p>
                  </div>
                  <Switch
                    id="sound-feedback"
                    ...
                    onCheckedChange={(checked) =>
                      handleToggleSwitch("audio", "soundFeedback", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleToggleSwitch("audio", "voiceControl", checked)
                    }
                  />
                </div>
            ...
            <div>
              ...
              <div className="space-y-4 bg-gray-50 p-4 rounded-lg">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label
                      htmlFor="gesture-navigation"
                      className="font-medium cursor-pointer"
                    >
                      Gesture Navigation
                    </Label>
                    <p className="text-xs text-gray-500">
                      Navigate using swipe and other touch gestures
                    </p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label
                      htmlFor="simplified-interface"
                      className="font-medium cursor-pointer"
                    >
                      Simplified Interface
                    </Label>
                    <p className="text-xs text-gray-500">
                      Reduce complexity of the user interface
                    </p>
                  </div>
                  <Switch
                    id="simplified-interface"
                    checked={
                      accessibilitySettings.navigation.simplifiedInterface
                    }
                    onCheckedChange={(checked) =>
                      handleToggleSwitch(
                        "navigation",
