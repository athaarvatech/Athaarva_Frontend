...
const providers = [
  {
    ...
    lastMessage:
      "Your latest test results look good. Let me know if you have any questions.",
  ...
  },
  {
    ...
    lastMessage:
      "Remember to take your medication as prescribed and monitor your blood pressure.",
  ...
  },
  {
    ...
    lastMessage:
      "The skin condition appears to be improving based on the photos you sent.",
...
export default function PatientMessagingPage() {
  ...
  const [conversations, setConversations] = useState<Provider[]>(providers);
          ...
          initialMessageHistory[conv.id] = [
            {
              ...
              content:
                "Hello! How have you been feeling since our last appointment?",
            ...
            },
            {
              ...
              sender: "You",
              content:
                "I've been feeling much better. The new medication has helped with my symptoms.",
  ...
  const filteredConversations = conversations.filter((conversation) => {
    ...
    if (activeFilter === "urgent")
      return matchesSearch && conversation.isUrgent;
    if (activeFilter === "attachments")
      return matchesSearch && conversation.hasAttachments;
  ...
  const sendMessage = () => {
    ...
    const newMessage: Message = {
      id: (messageHistory[selectedConversation.id]?.length || 0) + 1,
      sender: "You",
      content: messageText,
      timestamp: new Date(),
      status: "sent",
  ...
  const simulateDoctorResponse = () => {
    ...
    const convName = selectedConversation.name;
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        const doctorResponse: Message = {
          id: (messageHistory[convId]?.length || 0) + 2,
          sender: convName,
          content:
            "Thank you for the update. I'll make a note in your chart. Do you have any other concerns?",
          timestamp: new Date(),
          status: "delivered",
          priority: "normal",
          attachments: [],
        ...
        setMessageHistory((prev) => ({
          ...prev,
          [convId]: [...(prev[convId] || []), doctorResponse],
        }));
        ...
        <div className="p-4 border-b">
          ...
          <div className="flex space-x-2 mb-3 overflow-x-auto pb-1 text-sm">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-md whitespace-nowrap flex items-center ${
                activeFilter === "unread"
                  ? "bg-[#006D77] text-white"
                  : "bg-gray-100 text-gray-800"
              }`}
                      ...
                      <div className="flex flex-col items-end">
                        ...
                        >
                          <Star
                            size={16}
                            fill={
                              conversation.starred ? "currentColor" : "none"
                            }
                            className={
                              conversation.starred ? "text-yellow-500" : ""
                            }
                          />
                        </button>
        ...
        {selectedConversation ? (
                ...
                <div className="ml-3">
                  ...
                  <p className="text-xs text-gray-500 flex items-center">
                    {selectedConversation.isOnline ? (
                      ...
                      "Last active " +
                      formatDistanceToNow(selectedConversation.timestamp, {
                        addSuffix: true,
                      })
                    )}
                  </p>
                          ...
                          {message.attachments.map((attachment) => (
                            ...
                            >
                              ...
                              <a
                                ...
                                className={`p-1.5 ${
                                  message.sender === "You"
                                    ? "text-white hover:bg-[#004A56]"
                                    : "text-[#006D77] hover:bg-[#F0F9FA]"
                                } rounded-full`}
                      ...
                      <TooltipTrigger asChild>
                        <button
                          className={`p-2 text-gray-500 hover:bg-gray-100 rounded-full ${
                            showAIAssistant ? "bg-[#F0F9FA] text-[#006D77]" : ""
                          }`}
          ...
          <div className="flex-grow flex flex-col items-center justify-center bg-gray-50 p-4">
            ...
            <p className="text-gray-500 text-center mb-4 max-w-md">
              Communicate securely with your healthcare providers. All messages
              are encrypted and HIPAA-compliant.
            </p>
