      ...
      <Card className="mb-6">
        <CardContent className="p-6">
          <div className="text-sm text-gray-600 mb-4">
            <p>
              Manage your family members' health information, coordinate
              medications, and set up caregiving workflows. Privacy settings
                        ...
                        <TableCell>
                          <div className="flex items-center">
                            ...
                            {member.alerts > 0 && (
                              <Badge
                                variant="outline"
                                className="ml-2 h-5 px-1.5 bg-amber-50 text-amber-800 border-amber-200"
                              >
                                {member.alerts}
                              </Badge>
                            )}
                        ...
                        <TableCell>
                          <div className="text-xs text-gray-600">
                            <div className="flex items-center mb-1">
                              ...
                              <span>
                                {member.metrics.medications} medications
                              </span>
                            </div>
                            <div className="flex items-center">
                              <HeartPulse size={12} className="mr-1" />
                              <span>
                                {member.metrics.conditions.length} conditions
                              </span>
                            </div>
                          </div>
                        </TableCell>
                        <TableCell>
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem
                                onClick={() =>
                                  router.push(`/patient/family/${member.id}`)
                                }
                              >
