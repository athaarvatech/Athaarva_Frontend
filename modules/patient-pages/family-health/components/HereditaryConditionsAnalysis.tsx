...
interface HereditaryConditionsAnalysisProps {
  familyMembers: FamilyMember[];
  conditionsByGenerationData?: ChartDataItem[];
  conditionsDistributionData?: ChartDataItem[];
}
...
}: HereditaryConditionsAnalysisProps) => {
  return (
    <div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-600 mt-1">
                      These visualizations help identify patterns of health
                      conditions across generations, which can inform prevention
                      strategies and early screening recommendations.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <CardContent className="p-4">
              <div className="p-4 border rounded-md bg-white">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  A visual representation of health conditions across your
                  family tree. This helps identify patterns of hereditary
                  conditions.
                </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600 mt-1">
                      Based on your family health patterns, these are
                      recommended actions for preventive care and early
                      detection.
                    </p>
                  </div>
                </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                            With family history of hypertension, regular
                    ...
                    <div className="p-3 border rounded-md bg-white">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                            Annual cholesterol screening recommended due to
                            family cardiovascular risk factors.
                          </p>
                          <div className="flex mt-2">
                            <Badge className="bg-blue-100 text-blue-800 border-blue-200">
                              For: All Adults
                    ...
                    <div className="p-3 border rounded-md bg-white">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                            DASH diet recommended to manage blood pressure and
                    ...
                    <div className="p-3 border rounded-md bg-white">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                            Annual screening for prediabetes and diabetes
                            monitoring for affected family members.
                          </p>
                          <div className="flex mt-2">
                            <Badge className="bg-blue-100 text-blue-800 border-blue-200">
                              For: John, Adult Family
                            </Badge>
                            <Badge className="ml-2 bg-amber-100 text-amber-800 border-amber-200">
                              Priority: High
                            </Badge>
                    ...
                    <div className="p-3 border rounded-md bg-white">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                            Maintain healthy BMI through diet and exercise to
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-amber-600 mt-1">
                      These recommendations are based on family health patterns
                      and are not a substitute for professional medical advice.
                      Always consult with healthcare providers before making
                      health decisions.
                    </p>
                  </div>
                </div>
