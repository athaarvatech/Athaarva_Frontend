...
export function ClaimSubmissionFlow({ onClose }: { onClose: () => void }) {
  ...
  const removeAdditionalFile = (index: number) => {
    setFormData({
      ...formData,
      additionalDocuments: formData.additionalDocuments.filter(
        (_, i) => i !== index
      ),
    });
  };
  ...
  const isStepValid = () => {
    ...
    if (step === 2) {
      return (
        formData.insurancePlan && formData.memberID && formData.description
      );
    }
      ...
      <div className="p-4 border-b bg-[#F0F9FA]">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div
              className={`mx-2 h-px w-8 bg-gray-300 ${
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData({ ...formData, insurancePlan: value })
                }
              >
                <SelectTrigger>
                ...
                <SelectContent>
                  <SelectItem value="blue-cross">
                    Blue Cross Blue Shield PPO Family Plan
                  </SelectItem>
                  <SelectItem value="delta-dental">
                    Delta Dental Complete
                  </SelectItem>
            ...
            <div className="p-4 bg-blue-50 rounded-md mt-4">
              ...
              <p className="text-sm text-blue-700 mt-1">
                Including your complete insurance information speeds up claim
                processing time by up to 35%.
              </p>
            </div>
          </div>
        )}
        ...
        {step === 3 && (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600">
              Upload documents to support your claim. The receipt is required,
              but other documentation may help expedite your claim.
            </p>
                ...
                <div className="mt-2 border-2 border-dashed rounded-md p-6 text-center">
                  {formData.formFile ? (
                    ...
                    <>
                      <Upload className="h-8 w-8 text-gray-400 mx-auto mb-2" />
                      <p className="text-gray-500 mb-2">
                        Insurance claim form from your provider
                      </p>
                      <Input
                        type="file"
                        id="formFile"
                  ...
                  {formData.additionalDocuments.length > 0 ? (
                    <div className="space-y-2">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          document
                            .getElementById("additionalDocuments")
                            ?.click()
                        }
                      >
                        Add More Files
                    ...
                    <>
                      <Upload className="h-8 w-8 text-gray-400 mx-auto mb-2" />
                      <p className="text-gray-500 mb-2">
                        Supporting documents like referrals or EOBs
                      </p>
                      <Input
                        type="file"
              ...
              <div className="p-3 space-y-2">
                <div className="flex items-center">
                  ...
                  <span className="font-medium">
                    {formData.receiptFile?.name || "No receipt uploaded"}
                  </span>
                </div>
                {formData.formFile && (
                  <div className="flex items-center">
            ...
            <div className="p-4 bg-blue-50 rounded-md mt-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 mt-1">
                    Approved claims will be reimbursed via your preferred
        ...
        {submitted && (
          <div className="flex flex-col items-center justify-center h-full py-12">
            ...
            <p className="text-gray-600 text-center mt-2 max-w-md">
              ...
              business days. You'll receive updates via email and notifications
              in your account.
            </p>
