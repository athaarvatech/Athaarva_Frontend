  ...
  const [notifications, setNotifications] = useState([
    {
      ...
      message:
        "Sarah Thompson requested an appointment for tomorrow at 2:00 PM",
          ...
          filteredNotifications.map((notification) => (
            <div
              ...
              className={`relative p-2 rounded-md ${
                notification.read ? "bg-white hover:bg-gray-50" : "bg-[#F0F9FA]"
                ...
                >
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex items-center">
                      <span
                        className={`inline-block w-2 h-2 rounded-full mr-2 ${getPriorityIndicator(
