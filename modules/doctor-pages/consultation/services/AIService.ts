...
export async function generateDocumentationTemplate(
  ...
  console.log(
    `Generating template for patient ${patientId}, visit type: ${visitType}`
  );
  ...
  let subjectiveContent =
    "Patient reports persistent headaches occurring 3-4 times per week for the past month.";
  let objectiveContent =
    "BP: 128/82, HR: 76, RR: 16, Temp: 98.6°F, SpO2: 99%\nGeneral: Alert and oriented x3";
  let assessmentContent = "Migraine without aura (G43.009)";
  let planContent =
    "1. Start Sumatriptan 50mg at onset of headache\n2. Lifestyle modifications";
  ...
  const diagnoses: AIDiagnosisSuggestion[] = [
    ...
    },
    {
      ...
      references: [
        {
          title:
            "Medication-Overuse Headache: Clinical Features, Pathophysiology, and Management",
  ...
  return [
    {
      ...
      type: "medication",
      description:
        "50mg at onset of headache, may repeat after 2 hours if needed, not to exceed 200mg/day",
      evidenceLevel: "A",
      contraindications: [
    ...
    },
    {
      ...
      type: "lifestyle",
      description:
        "Regular sleep schedule, stress reduction techniques, identify and avoid triggers",
      evidenceLevel: "B",
    },
    {
      name: "Headache diary",
      type: "followup",
      description:
        "Maintain headache diary to track frequency, severity, and potential triggers",
      evidenceLevel: "B",
    },
  ];
}
  ...
  return [
    {
      severity: "medium",
      description:
        "Potential interaction between Sumatriptan and Sertraline may increase risk of serotonin syndrome",
    },
  ];
}
  ...
  return [
    {
      ...
      content:
        "Migraines are severe headaches that can cause throbbing pain, nausea, and sensitivity to light and sound...",
      url: "https://healthcare.com/patient-education/migraines",
    },
    {
      title: "Sumatriptan: Usage and Side Effects",
      content:
        "Sumatriptan is a medication used to treat migraine headaches. It works by narrowing blood vessels around the brain...",
...
export async function analyzeConsultationInRealTime(
  ...
  const potentialConcerns = identifyPotentialConcerns(
    transcription,
    medicalTerms,
    patientContext
  );
...
export async function getContextAwareSuggestions(
  ...
  console.log(
    `Getting context-aware suggestions for ${currentSection} section`
  );
  ...
  switch (currentSection) {
    ...
    case "objective":
      suggestions.push({
        ...
        confidence: 0.92,
        reasoning:
          "Complete neurological examination is recommended for all headache evaluations",
    ...
    case "plan":
      suggestions.push({
        ...
        confidence: 0.83,
        reasoning:
          "Frequency of headaches suggests need for preventive treatment",
