...
import { ViewType, Appointment } from "./type";
...
export const hasScheduleConflict = (
  ...
  return (
    isWithinInterval(appointment1.startTime, {
      start: appointment2.startTime,
      end: appointment2.endTime,
    }) ||
    isWithinInterval(appointment1.endTime, {
      start: appointment2.startTime,
      end: appointment2.endTime,
    }) ||
    (isBefore(appointment1.startTime, appointment2.startTime) &&
      isAfter(appointment1.endTime, appointment2.endTime))
  );
};
